...
const zh: Record<string, string> = {
  ...
  connect_failed: "连接失败：",
  cli_auth: "CLI 授权",
  cli_auth_terminal: ">_ riffpad // cli-auth",
  cli_auth_status: "等待授权…",
  cli_auth_hint: "授权后回到终端，登录会自动完成。",
  theme_light: "切换到浅色模式",
  theme_dark: "切换到深色模式",
  sidebar_open: "打开菜单",
  ...
  session_delete: "删除",
  rename_title: "重命名会话",
  rename_ph: "会话名称（留空恢复默认）",
  rename_save: "保存",
  saving: "保存中…",
  delete_title: "删除会话",
  delete_hint: "仅从客户端移除，电脑上的 agent 不会停止。",
  deleting: "删除中…",
  cancel: "取消",
  time_just_now: "刚刚",
  time_min_ago: "{n} 分钟前",
  ...
  no_sessions: "暂无会话",
  list_offline: "离线，重连中…",
  offline_title: "daemon 离线",
  offline_hint: "电脑上的 daemon 没有连上中继——会话可能还在运行，只是暂时看不到。请确认电脑没有休眠、daemon 正在运行。",
  device_revoked_action: "重新配对",
  empty_title: "还没有会话？",
  empty_run_hint: "在电脑上运行下面的命令创建会话：",
  start_failed: "启动失败",
  ...
  history_loading: "加载更早消息…",
  load_earlier: "显示更早的 {n} 条消息",
  jump_bottom: "底部",
  session_default: "会话",
  ...
  session_key_mismatch: "解密连续失败：服务端密钥可能已被重置（如 keys.json 被删除），请重新配对",
  ...
  rejected: "已拒绝",
  sending: "发送中…",
  approval_pending: "待发送：网络恢复后会自动发出",
  approval_not_delivered: "未送达：连接已关闭，审批未发送，请重试",
  approval_expired: "已过期：daemon 端该审批已失效，本次操作未生效",
  ...
  kill_switch: "熔断",
  no_devices: "暂无已配对设备",
  device_stale_hint: "更换设备或清除浏览器数据后，旧设备仍会留在设备列表里，需在设备管理中手动撤销。",
  revoke: "撤销",
  device: "设备",
...
const en: Record<string, string> = {
  ...
  cli_auth: "CLI auth",
  cli_auth_terminal: ">_ riffpad // cli-auth",
  cli_auth_status: "Waiting for authorization…",
  cli_auth_hint: "After authorizing, return to your terminal — sign-in completes automatically.",
  ...
  copied: "Copied",
  pairing: "Pairing…",
  pair_code_used: "This pairing code has already been used. Generate a new one.",
  ...
  rename_ph: "Session name (empty resets to default)",
  rename_save: "Save",
  saving: "Saving…",
  delete_title: "Delete session",
  delete_hint: "Removes it from this app only; the agent on your computer keeps running.",
  deleting: "Deleting…",
  cancel: "Cancel",
  ...
  list_offline: "Offline, reconnecting…",
  offline_title: "Daemon offline",
  offline_hint: "The daemon on your computer is not connected to the relay — your sessions may still be running, just unreachable. Make sure the computer is awake and the daemon is up.",
  device_revoked_action: "Re-pair",
  empty_title: "No sessions yet?",
  empty_run_hint: "Start one on your computer with:",
  ...
  history_loading: "Loading older…",
  load_earlier: "Show {n} earlier messages",
  jump_bottom: "Bottom",
  ...
  session_key_mismatch: "Decryption keeps failing: the server's identity key was likely reset (e.g. keys.json deleted). Please re-pair.",
  ...
  rejected: "Rejected",
  sending: "Sending…",
  approval_pending: "Queued — will be sent once reconnected",
  approval_not_delivered: "Not delivered: the connection closed before sending. Please retry.",
  approval_expired: "Expired: the daemon no longer awaits this approval; your tap had no effect",
  ...
  devices: "Devices",
  devices_status: "{n} active",
  device_active: "Active {time}",
  ...
  device_stale_hint: "If you switch devices or clear browser data, the old device stays paired — revoke it manually in the device manager.",
  revoke: "Revoke",
  device: "device",
