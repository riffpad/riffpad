...
const zh: Record<string, string> = {
  ...
  auth_terminal: ">_ riffpad // app",
  auth_required: "// 需要登录",
  auth_desc: "登录以访问你的 daemon 会话。",
  cloud_checking: "检查服务状态…",
  cloud_online: "云服务正常",
  cloud_offline: "云服务不可用",
  cli_install_label: "快速安装 CLI：",
  back_home: "← 返回 riffpad.ai",
  or: "或",
  username_ph: "用户名",
  password_ph: "密码",
  login_btn: "登录",
...
const en: Record<string, string> = {
  ...
  auth_desc: "Sign in to access your active daemon sessions.",
  cloud_checking: "Checking service…",
  cloud_online: "Cloud Service Active",
  cloud_offline: "Cloud Service Offline",
  cli_install_label: "Quick CLI Install:",
