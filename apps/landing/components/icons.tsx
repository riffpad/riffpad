// Minimal single-color icon set for marketing surfaces.
// Brand marks (GitHub/Discord) are filled 24×24 paths; utility icons are
// line-based to match the "minimal glyph" design language.
