      ...
      tables: [
        {
          ...
          rows: [
            {
              riffpad: "Agent loop with tools until solved",
              other: "Single or few LLM calls",
            },
            {
              riffpad: "Add Skills on demand",
              other: "Locked to platform ecosystem",
            },
            {
              riffpad: "Real file system & workspace",
              other: "Scattered in chat history",
            },
          ],
        },
        {
          ...
          rows: [
            {
              riffpad: "One sentence, zero setup",
              other: "Install, create repo, configure env",
            },
            {
              riffpad: "Cloud, syncs everywhere",
              other: "Local machine only",
            },
            {
              riffpad: "Fast creative validation",
              other: "Heavy codebase engineering",
            },
          ],
        },
      ],
      ...
      tables: [
        {
          ...
          rows: [
            {
              riffpad: "Agent loop，自动调用工具直到解决",
              other: "单次或少量 LLM 调用",
            },
            {
              riffpad: "按需安装 Skill 扩展能力",
              other: "受限于平台自带生态",
            },
            {
              riffpad: "真实文件系统，工作区可导出",
              other: "内容散落在对话里",
            },
          ],
        },
