...
`,
		...
		"run_tui_starting":            "Starting %s TUI (session hosted by daemon)…",
		"run_tui_pty_connect_failed":  "failed to connect session PTY: %v",
		"run_tui_exited":              "%s TUI exited, session %s closed.",
		"windows_tui_unsupported":     "foreground TUI is not supported on Windows",
		"codex_tui_starting":          "Starting Codex TUI (session hosted by daemon)…",
		"codex_tui_wait_failed":       "failed to wait for Codex session readiness: %v",
		"codex_tui_not_ready":         "Codex session not ready (status %d)",
		"codex_not_found":             "codex executable not found: %v",
		"codex_tui_exit_error":        "Codex TUI exited: ",
		"codex_tui_exited":            "Codex TUI exited, session %s closed.",
	},
	"zh": {
...
`,
		...
		"run_tui_starting":            "正在启动 %s TUI（会话已托管到 daemon）…",
		"run_tui_pty_connect_failed":  "连接会话 PTY 失败: %v",
		"run_tui_exited":              "%s TUI 已退出，会话 %s 已关闭。",
		"windows_tui_unsupported":     "前台 TUI 暂不支持 Windows",
		"codex_tui_starting":          "正在启动 Codex TUI（会话已托管到 daemon）…",
		"codex_tui_wait_failed":       "等待 Codex 会话就绪失败: %v",
		"codex_tui_not_ready":         "Codex 会话未就绪（状态 %d）",
		"codex_not_found":             "未找到 codex 可执行文件: %v",
		"codex_tui_exit_error":        "Codex TUI 已退出：",
		"codex_tui_exited":            "Codex TUI 已退出，会话 %s 已关闭。",
	},
}
